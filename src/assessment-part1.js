...
for (var i = 0; i < arrStr.length; i++) {
    var newStr = arrStr[i].charAt(0).toUpperCase();
}
return newStr.join(" ");
}
...
function valueType(param1, param2) {
  var param1Type = typeof param1;
  var param2Type = typeof param2;
  if (param1Type === param2Type && param1 === param2) {
    return "Exactly the same";
  } else if (param1Type === param2Type && param1 !== param2) {
